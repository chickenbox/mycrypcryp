namespace mycrypcryp {
    ...
    export class App{
        ...
        private async testBinance(){
            ...
            console.log( await new com.danborutori.cryptoApi.CryptoCompare().getPrice("BTC", "HKD"))

            const api = new com.danborutori.cryptoApi.Binance()
            ...
            const symTrends = (await Promise.all( symbols.map( async symbol=>{
                ...
                const trend = new com.danborutori.cryptoApi.util.TrendWatcher( data.map(d=>{
                    return {
